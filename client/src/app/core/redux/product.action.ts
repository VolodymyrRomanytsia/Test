...
export type ProductAction = LoadProducts | AddProduct | DeleteProduct | AddViewedProduct | FilterMinMaxProduct | SortMinMaxProduct | SortMaxMinProduct | DeleteViewedProduct